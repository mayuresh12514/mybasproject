		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapzcovid19dashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapzcovid19dashboard-display": {
								"semanticObject": "comsapzcovid19dashboard",
								"action": "display",
								"description": "A Fiori application on World Covid 19 Report",
								"title": "Covid 19 Dashboard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.zcovid19dashboard",
									"url": sap.ui.require.toUrl("com/sap/zcovid19dashboard")
								}
							}
						}
					}
